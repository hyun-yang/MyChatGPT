...
from image.view.ImageList import ImageList
from util.Constants import Constants, UI
from util.Utility import Utility


class ImageHistory(QWidget):
    new_image_signal = pyqtSignal(str)
    delete_image_signal = pyqtSignal()
    ...
    def initialize_ui(self):
        ...
        self.add_button.clicked.connect(self.add_new_image)
        ...
        self._image_list = ImageList(self.model)
    ...
    def add_new_image(self):
        self.new_image_signal.emit(Constants.NEW_IMAGE)

    def delete_image(self):
        self.delete_image_signal.emit()
