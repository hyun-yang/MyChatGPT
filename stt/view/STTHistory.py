...
from stt.view.STTList import STTList
from util.Constants import Constants, UI
from util.Utility import Utility


class STTHistory(QWidget):
    new_stt_signal = pyqtSignal(str)
    delete_stt_signal = pyqtSignal()
    ...
    def initialize_ui(self):
        ...
        self._stt_list = STTList(self.model)

        main_layout = QVBoxLayout()
        main_layout.addWidget(top_widget)
        main_layout.addWidget(self._stt_list)

        self.setLayout(main_layout)

    def add_new_stt(self):
        self.new_stt_signal.emit(Constants.NEW_STT)

    def delete_stt(self):
        self.delete_stt_signal.emit()
