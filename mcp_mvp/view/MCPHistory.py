...
from mcp_mvp.view.MCPList import MCPList
from util.Constants import Constants, UI
from util.Utility import Utility


class MCPHistory(QWidget):
    new_mcp_signal = pyqtSignal(str)
    delete_mcp_signal = pyqtSignal()
    ...
    def initialize_ui(self):
        ...
        self._mcp_list = MCPList(self.model)

        main_layout = QVBoxLayout()
        main_layout.addWidget(top_widget)
        main_layout.addWidget(self._mcp_list)

        self.setLayout(main_layout)

    def add_new_mcp(self):
        self.new_mcp_signal.emit(Constants.NEW_MCP)

    def delete_mcp(self):
        self.delete_mcp_signal.emit()
