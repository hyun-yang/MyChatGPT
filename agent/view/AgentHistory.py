...
from agent.view.AgentList import AgentList
from util.Constants import Constants, UI
from util.Utility import Utility


class AgentHistory(QWidget):
    new_agent_signal = pyqtSignal(str)
    delete_agent_signal = pyqtSignal()
    ...
    def initialize_ui(self):
        ...
        self.add_button.clicked.connect(self.add_new_agent)
        ...
        self._agent_list = AgentList(self.model)

        main_layout = QVBoxLayout()
        main_layout.addWidget(top_widget)
        main_layout.addWidget(self._agent_list)
